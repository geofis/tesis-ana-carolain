...
st_write(transectos, 'transectos/pre_2009_tramo_este.gpkg')
...
st_write(transectos, 'transectos/pre_2009_tramo_oeste.gpkg')
...
st_write(transectos, 'transectos/pos_2013_tramo_palenque_este.gpkg')
...
# Crear transectos
transectos <- create_transect(x = linea_ref, 100, reverse = T) %>% rename(transect=coastr_id)
st_write(transectos, 'transectos/pos_2013_tramo_palenque_centro.gpkg')
...
# Crear transectos
transectos <- create_transect(x = linea_ref, 200, reverse = T) %>% rename(transect=coastr_id)
st_write(transectos, 'transectos/pos_2013_tramo_palenque_oeste.gpkg')
...
st_write(transectos, 'transectos/pos_2013_tramo_nizao_este.gpkg')
...
st_write(transectos, 'transectos/pos_2013_tramo_nizao_oeste.gpkg')
