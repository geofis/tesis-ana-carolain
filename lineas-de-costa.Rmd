...
knitr::opts_chunk$set(echo = TRUE, cache = F, fig.width = 11, fig.height = 8)
```
...
generar_tabla_de_tasas_de_cambio <- function(tasas_de_cambio, titulo) {
  as.data.frame(t(sapply(tasas_de_cambio, function(x) x[[c(1)]]))) %>% 
...
tasas_de_cambio %>% 
  generar_tabla_de_tasas_de_cambio(titulo = 'Tasa de cambio pre-2009 para transectos del Tramo Este')
```
...
tasas_de_cambio <- lapply(
  ...
  setNames(paste('Transecto', unique(distances$transect)))
tasas_de_cambio %>% 
  generar_tabla_de_tasas_de_cambio(titulo = 'Tasa de cambio pre-2009 para transectos del Tramo Oeste')
```
...
tasas_de_cambio <- lapply(
  ...
  setNames(paste('Transecto', unique(distances$transect)))
tasas_de_cambio %>% 
  generar_tabla_de_tasas_de_cambio(titulo = 'Tasa de cambio pos-2013 (L8) para transectos del Tramo Palenque Este')
```
...
tasas_de_cambio <- lapply(
  ...
  setNames(paste('Transecto', unique(distances$transect)))
tasas_de_cambio %>% 
  generar_tabla_de_tasas_de_cambio(titulo = 'Tasa de cambio pos-2013 (L8) para transectos del Tramo Palenque Centro')
```
...
tasas_de_cambio <- lapply(
  ...
  setNames(paste('Transecto', unique(distances$transect)))
tasas_de_cambio %>% 
  generar_tabla_de_tasas_de_cambio(titulo = 'Tasa de cambio pos-2013 (L8) para transectos del Tramo Palenque Oeste')
```
...
tasas_de_cambio <- lapply(
  ...
  setNames(paste('Transecto', unique(distances$transect)))
tasas_de_cambio %>% 
  generar_tabla_de_tasas_de_cambio(titulo = 'Tasa de cambio pos-2013 (L8) para transectos del Tramo Nizao Este')
```
...
tasas_de_cambio <- lapply(
  ...
  setNames(paste('Transecto', unique(distances$transect)))
tasas_de_cambio %>% 
  generar_tabla_de_tasas_de_cambio(titulo = 'Tasa de cambio pos-2013 (L8) para transectos del Tramo Nizao Oeste')
```
